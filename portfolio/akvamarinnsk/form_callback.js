...
var form = $("#request_callback"),
    ...
    **/
    ...
    function callAlert(message, type) {
        ...
        var alert = '<div class="alert alert-success alert-dismissible shadow-lg" role="alert"><strong>' + message + '</strong><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>'
